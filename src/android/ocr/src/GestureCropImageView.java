...
public class GestureCropImageView extends CropImageView {
    ...
    private OnCropImageViewChangedListener onCropImageViewChangedListener;
    ...
    public OnCropImageViewChangedListener getOnCropImageViewChangedListener() {
        return onCropImageViewChangedListener;
    }

    public void setOnCropImageViewChangedListener(OnCropImageViewChangedListener onCropImageViewChangedListener) {
        this.onCropImageViewChangedListener = onCropImageViewChangedListener;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if ((event.getAction() & MotionEvent.ACTION_MASK) == MotionEvent.ACTION_UP) {
            ...
            if(getOnCropImageViewChangedListener() != null){
                getOnCropImageViewChangedListener().onCropImageViewChangedListener();
            }
        }
        return true;
    }
    ...
    private void setupGestureListeners() {
        mGestureDetector = new GestureDetector(getContext(), new GestureCropImageView.GestureListener(), null, true);
        mScaleDetector = new ScaleGestureDetector(getContext(), new GestureCropImageView.ScaleListener());
        mRotateDetector = new RotationGestureDetector(new GestureCropImageView.RotateListener());
    }
