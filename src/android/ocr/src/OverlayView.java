...
public class OverlayView extends View {
    ...
    protected void init() {
        mTouchPointThreshold = getResources().getDimensionPixelSize(r.getId("dimen", "ucrop_default_crop_rect_corner_touch_threshold"));
        mCropRectMinSize = getResources().getDimensionPixelSize(r.getId("dimen", "ucrop_default_crop_rect_min_size"));
        mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(r.getId("dimen", "ucrop_default_crop_rect_corner_touch_area_line_length"));
...
//        }
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        mCircleDimmedLayer = a.getBoolean(r.getId("styleable", "ucrop_UCropView_ucrop_circle_dimmed_layer"), DEFAULT_CIRCLE_DIMMED_LAYER);
        mDimmedColor = a.getColor(r.getId("styleable", "ucrop_UCropView_ucrop_dimmed_color"),
                getResources().getColor(r.getId("color", "ucrop_color_default_dimmed")));
        ...
        mShowCropFrame = a.getBoolean(r.getId("styleable", "ucrop_UCropView_ucrop_show_frame"), DEFAULT_SHOW_CROP_FRAME);

        initCropGridStyle(a);
        mShowCropGrid = a.getBoolean(r.getId("styleable", "ucrop_UCropView_ucrop_show_grid"), DEFAULT_SHOW_CROP_GRID);
    }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = a.getDimensionPixelSize(r.getId("styleable", "ucrop_UCropView_ucrop_frame_stroke_size"),
                getResources().getDimensionPixelSize(r.getId("dimen", "ucrop_default_crop_frame_stoke_width")));
        int cropFrameColor = a.getColor(r.getId("styleable", "ucrop_UCropView_ucrop_frame_color"),
                getResources().getColor(r.getId("color", "ucrop_color_default_crop_frame")));
    ...
    private void initCropGridStyle(@NonNull TypedArray a) {
        int cropGridStrokeSize = a.getDimensionPixelSize(r.getId("styleable", "ucrop_UCropView_ucrop_grid_stroke_size"),
                getResources().getDimensionPixelSize(r.getId("dimen", "ucrop_default_crop_grid_stoke_width")));
        int cropGridColor = a.getColor(r.getId("styleable", "ucrop_UCropView_ucrop_grid_color"),
                getResources().getColor(r.getId("color", "ucrop_color_default_crop_grid")));
        mCropGridPaint.setStrokeWidth(cropGridStrokeSize);
        mCropGridPaint.setColor(cropGridColor);

        mCropGridRowCount = a.getInt(r.getId("styleable", "ucrop_UCropView_ucrop_grid_row_count"), DEFAULT_CROP_GRID_ROW_COUNT);
        mCropGridColumnCount = a.getInt(r.getId("styleable", "ucrop_UCropView_ucrop_grid_column_count"), DEFAULT_CROP_GRID_COLUMN_COUNT);
    }
